...
そうですね、土が見える辺りまで調整しておきましょう。具体的には、**Sizeが(4.3, 0.2)**、**Centerが(0, -0.03)**位です。
...
シーンを見てください。Player_Fly0が確認出来ますね。シーンとテクスチャ名で紛らわしいので、Playerとリネームましょう。リネームするには、Inspector上のPlayer_Fly0を選択し、名前を**Playerに変更**します。
