...
(function() {
    ...
    var REMOTE_PACKAGE_SIZE = 4255708;
    var PACKAGE_UUID = '50d93889-5639-4c9e-abe1-8fb8327c010c';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 51532, 0, 0).open('GET', '/mainData');
    new DataRequest(51532, 51888, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(51888, 2181228, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(2181228, 3741600, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3741600, 4255708, 0, 0).open('GET', '/Resources/unity_builtin_extra');
